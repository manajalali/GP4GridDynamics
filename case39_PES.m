...
mpc.bus = [
	1	1	0   	0   	0	0	2	1.0393836	-13.536602	345     1	1.06	0.94;
	...
	8	1	522     176 	0	0	1	0.99787232	-13.335844	345	1	1.06	0.94;
	9	1	0       0   	0	0	1	1.038332	-14.178442	345	1	1.06	0.94;
	10	1	0       0       0	0	1	1.0178431	-8.170875	345	1	1.06	0.94;
	11	1	0       0       0	0	1	1.0133858	-8.9369663	345	1	1.06	0.94;
	12	1	7.5 	88      0	0	1	1.000815	-8.9988236	345	1	1.06	0.94;
	...
	20	1	628     103     0	0	3	0.99101054	-6.8211783	345	1	1.06	0.94;
	...
	24	1	308.6	-92 	0	0	3	1.038001	-9.9137585	345	1	1.06	0.94;
...
%; -----------
% machine data, base mva = 1000 each
%       1. bus number,
%       2. inertia constant H(sec),
%       3. damping coefficient d_o(pu),
%       4. dampling coefficient d_1(pu),
k1 = 1/pi/60; % constant is 2/omega = 2/(2*pi*f)
mpc.M = ... 
  [30.0000    42.000*k1         0         0;
   31.0000    30.300*k1         0         0;
   32.0000    35.800*k1         0         0;
   33.0000    28.600*k1         0         0;
   34.0000    26.000*k1         0         0;
   35.0000    34.800*k1         0         0;
   36.0000    26.400*k1         0         0;
   37.0000    24.300*k1         0         0;
   38.0000    34.500*k1         0         0;
   39.0000   500.000*k1         0         0];
